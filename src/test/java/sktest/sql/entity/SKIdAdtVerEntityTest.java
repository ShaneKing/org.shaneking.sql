...
public class SKIdAdtVerEntityTest extends SKUnit {
  ...
  public void whereOCs() throws Exception {
    ...
    prepareEntity.setVer(1).setInvalid(String0.Y).setModDateTime(SKTEST1_DATE_TIME).setModUserId(SKTEST1_USER_ID).setId(SKEntityTest.SKTEST1_ID).setWhereOCs(ocMap);
